...
(function() {
    let panelVisible = window.innerWidth > 640; // hidden by default on mobile
    let analytics = {
        listeners: 23,
    ...
    function getOrCreateToggle() {
        let btn = document.getElementById('analytics-toggle');
        if (!btn) {
            ...
            btn.addEventListener('click', function() {
                ...
                const panel = document.getElementById('radio-analytics-demo');
