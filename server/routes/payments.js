...
router.post('/confirm-payment', authenticateUser, async (req, res) => {
    try {
        ...
        await processBeatPurchase(transaction);
...
router.get('/stats', authenticateUser, (req, res) => {
    try {
        // Use real analytics from analyticsTracker and treasuryManager
        const analyticsTracker = require('../utils/analyticsTracker');
        const treasuryManager = require('../utils/treasuryManager');
        ...
        res.json({
            ...
            stats: {
                ...
                monthlyGrowth: treasury.monthlyGrowth || null,
                topSellingBeats: revenue.topRevenueUsers,
...
router.userWallets = userWallets;
