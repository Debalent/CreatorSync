...
=======
> **Full production architecture**: See [`docs/PLATFORM_ARCHITECTURE.md`](docs/PLATFORM_ARCHITECTURE.md) for the complete technical spec, FinTech system, UX flows, and scaling strategy.

### **Platform Commission**

**12.5% commission** is automatically deducted from every marketplace and transactional payout. Commission is applied to:
- Beat sales (all license tiers)
- Custom production / service orders
- Collaboration splits
- Sync licensing fees
- Livestream monetization pass-through
- Distribution revenue earn-through

Elite / Label tier receives a **reduced 8.5% commission**.

### **Subscription Tiers**

| Tier | Monthly | Annual /mo | 2-Year /mo |
|------|---------|------------|------------|
| **Free** | $0 | $0 | $0 |
| **Creator** | $14.99 | $11.99 (save 20%) | $9.74 (save 35%) |
| **Pro** | $29.99 | $23.99 (save 20%) | $19.49 (save 35%) |
| **Elite / Label** | $99.99 | $79.99 (save 20%) | $64.99 (save 35%) |

#### **Free Tier**
- 10 beat uploads/month, 5 GB storage, 10 AI credits
- Marketplace access (buy & sell), community forum

#### **Creator** — $14.99/mo
- 50 beat uploads/month, 50 GB storage, 100 AI credits
- Collaboration (3 users), 3 distribution releases/year
- Standard MixMaster, advanced analytics (90-day)

#### **Pro** — $29.99/mo ⭐ Most Popular
- Unlimited uploads, 250 GB storage, unlimited AI (The Finisher)
- Collaboration (10 users), unlimited distribution to 14 DSPs
- ISRC & UPC generation, royalty dashboard, publishing admin
- MixMaster Pro + stem separation, YouTube + Twitch livestream

#### **Elite / Label** — $99.99/mo
- Everything in Pro + 2 TB storage
- 25-user collaboration, all 5 streaming platforms simultaneously
- 25-artist roster management, white-label storefront
- Custom contract builder, split treasury auto-payout
- Full REST API + webhooks, dedicated account manager
- **Reduced 8.5% commission**

### **Additional Revenue Streams**
- **Featured Placement**: Homepage ($49/wk), genre top ($29/wk), search boost ($19/wk)
- **AI Credit Top-Ups**: $9.99 per 100 additional credits
- **Cloud Storage Expansion**: $4.99/50 GB/month
- **Verified Creator Badge**: $9.99 one-time
- **Promoted Beat Packs**: $99/campaign

### **Growth Strategy**
- **Freemium Model**: Free marketplace access drives subscription upgrades
- **Creator Incentives**: Revenue sharing, affiliate program, style-profile improvement rewards
- **Viral Features**: Livestream collaboration, real-time co-production, beat sharing
- **Strategic Partnerships**: DSP integrations, PRO affiliations, hardware partners
>>>>>>> gh-pages-deploy
